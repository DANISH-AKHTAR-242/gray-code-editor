...
// FIX: Removed the Node.js 'stream' import
...
export const AIChatSidePanel: React.FC<AIChatSidePanelProps> = ({
  ...
  // FIX: Extracted core logic from event handlers
  const doSendMessage = async () => {
    ...
    try {
      const contextualMessage = getChatModePrompt(chatMode, currentInput);
      ...
      if (streamResponse && response.body) {
        ...
        // FIX: Handle non-streaming JSON response
  ...
  // FIX: Create separate handlers for form and keydown
            ...
            <div className="flex items-center justify-between p-6">
              <div className="flex items-center gap-3">
                <div className="relative w-10 h-10 border rounded-full flex flex-col justify-center items-center">
                  {/* FIX: Use an existing image */}
                  <Image src={"/login.svg"} alt="Logo" width={28} height={28} />
                </div>
                <div>
